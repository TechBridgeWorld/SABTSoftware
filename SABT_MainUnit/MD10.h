...
// State definitions
#define MD10_INITIAL                  0          // Just started, plays welcome message
#define MD10_SELECT_MODE				1		   // Selecting the submode
#define MD10_INIT				2		   // Submode initialisation
#define MD10_REQUEST_INPUT            3          // Request for input from user - part 1
#define MD10_CELL1					4		   // Waiting for user input - cell 1
#define MD10_CELL2					5		   // Waiting for user input - cell 2   
#define MD10_CHECK				    6		   // Checks if pattern is right
#define MD10_REQUEST_WRITE			7		   // Requests the user to write in the pattern
#define MD10_SPELL_PATTERN			8		   // Spells out the pattern for the user
