...
#define MD5_STATE_WAIT_INPUT_1      1          // Player 1 enters word
#define MD5_STATE_PROC_INPUT_1      2          // Check for valid input word
#define MD5_STATE_WAIT4P2           3          // Wait for transition to player2 to press enter
#define MD5_STATE_SAY_STATUS        4          // Read out current word
#define MD5_STATE_SAY_MISTAKES      5          // Read out current mistakes
#define MD5_STATE_ASK_FOR_GUESS     6          // Prompt user for input
#define MD5_STATE_WAIT_INPUT_2      7          // Waiting for user input
#define MD5_STATE_PROC_INPUT_2      8          // Process user input
#define MD5_STATE_CHECK_MATCH       9          // Valid input was entered
#define MD5_STATE_EVALUATE_GAME     10          // Check for win or lose
#define MD5_STATE_READ_WORD         11         // User has finished the game
