...
#define MP3_DOT_1 "dot1"
#define MP3_DOT_2 "dot2"
#define MP3_DOT_3 "dot3"
#define MP3_DOT_4 "dot4"
#define MP3_DOT_5 "dot5"
#define MP3_DOT_6 "dot6"
#define MP3_DOT_C "dotC"
#define MP3_DOT_E "dotE"


////////////// SYS ////////////////

#define MP3_BACQ  "BACQ"    	// Returning to the question now.
#define MP3_HELPM "HELPM"     // Help menu.
#define MP3_HELPX "HELPX"     // Exit help menu.
...
#define MP3_VOL   "VOL"       // pop sound
#define MP3_WELC  "WELC"      // Welcome to the stand-alone braille tutor.
...
#define MP3_LETTER_COMMANDS	"cmndlt"	// Mode 2:  Tho move to the next letter, press right. To move to the previous letter, press left. To select a letter, press enter.
#define MP3_WORD_COMMANDS	"cmndwd"	// To skip the question, press enter. To try again, press cancel. To hear the question again, press left. To hear the answer, press right.
#define MP3_HINDI_COMMANDS  "cmndhi"	// ???
...
#define MP3_PLEASE_PRESS  	"plsprs"    // Please press:
#define MP3_GUESS_A_LETTER 	"guessl"    // Guess a letter
#define MP3_SPELL_WORD    	"splwrd"    // Please spell the word:
#define MP3_WRITE_NUMBER_	"splnum"    // Please write the number that is equal to:
#define MP3_ENTER_NEW_WORD  "NGAM"      // Please enter a new word.  // WHERE IS THIS USED?
...
#define MP3_NO_NUMBER 		"nonum"    	// No number is entered. Please try again.
#define MP3_NO_NUMBER_K 	"nonumk"    // No number is entered. Please try again.  [Kannada]

#define MP3_WOSM 			"WOSM"      // You entered and answer without a number symbol.
...
#define MP3_ZERO       	"#0"
#define MP3_ONE        	"#1"
//#define MP3_TEN       	"ENG_#10"   // defined elsewhere -- fix that!
...
#define  KAN_CORR
#define  KAN_FCEL
// wwhere is Kannada "good"?
#define  KAN_INVP
#define  KAN_LCEL
#define  KAN_NCEL
// where is Kannada "nice work"
// where is Kannada NLET
#define  KAN_NNUM
// where is Kannada NO
// where is Kannada NPAT
#define  KAN_NUMS
// where is Kannada PCEL
#define  KAN_SETR // DUPLICATE
#define  KAN_TAGA
#define  KAN_WRNG
// where is Kannada YES */
...
#define MP3_WELCOME 		"welc"
	...
	// Mode 11: Welcome to the everyday noises game. (INT)
	// Mode 12:
	// Mode 13:
...
#define MP3_INSTRUCTIONS "inst"
	// Mode 2: To submit your answer, please press enter. To hear the letter again, press left. To change the letter, press right. To clear a cell, press cancel.
	...
	// Mode 7: To submit your answer, please press enter. To hear the letter again, press left. To change the letter, press right. To clear a cell, press cancel.
	// Mode 8: To submit your answer, please press enter. To hear the letter again, press left. To change the letter, press right. To clear a cell, press cancel.
	// Mode 9: To submit your answer, press enter. TO move to the next or previous cell, use left or right. To clear a cell, press cancel. For help, press cancel two times.
	// Mode 12: [In Kannada]
	// Mode 13: To submit your answer, press enter. To move to the next or previous cell, use left or right. To clear a cell, press cancel. For, press cancel two times.
	// Mode 14/15: Spell the word, pressing enter after each letter. Press left to repeat the word. Press right ot skip to the next word. Press cancel to erase your entry.


#define MP3_SKIP         "skip"
	
	// Mode 3:  To skip this animal, press enter. To continue playing, press cancel.
	// Mode 7:  [Unknown directions in Hindi.]
	// Mode 11: To skip this object, press enter. To continue, press cancel.
	// Mode 13: You are in the help menu. To hear the question again, press left. To hear the answer and skip the question, perss right. To hear the answer you have entered so far, press enter. To exit the help menu, press cancel. To exit the mode, long press cancel.
...
#define MP3_COMMANDS     "comm"    // FORMERLY RMEN
	// Mode 2: To skip this letter, press enter. To try again, press cancel. To change the letter, use the left and right buttons and then press enter.
	// Mode 7: To skip this letter, press enter. To try again, press cancel. To change the letter, use the left and right buttons and then press enter.
	// Mode 8: To skip this number, press enter. To try again, press cancel. To change the number, use the left and right buttons and then press enter.
	// Mode 12: [In Kannada]



/*
#define MP3_PLSA PLSA    // Please write the name of the animal that makes the sound:
#define MP3_PLSB PLSB    // Please write the spelling of this animal.
#define MP3_PLWR PLWR    // Please write:
#define MP3_PRSS PRSS    // Press
...
#define MP3_CL1 CL1    // Cell 1
#define MP3_CL2 CL2    // Cell 2
#define MP3_NXT NXT    // Next cell
#define MP3_TRY TRY    // Try again
#define MP3_WRT WRT    // To write
#define MP3_DICT DICT    // Dictation mode.
#define MP3_PABR PABR    // Practice abbreviations.
#define MP3_PCON PCON    // Practice contractions
#define MP3_WEL2 WEL2    // Submode under development. Please press cancel to exit to submode menu.
#define MP3_WEL3 WEL3    // Submode under development. Please press cancel to exit to submode menu.
...
#define MP3_PLSA PLSA    // Please write the name of the object that makes the sound:
#define MP3_PLSB PLSB    // Please write the spelling of this object:
#define MP3_PLWR PLWR    // Please write:
#define MP3_PRSS PRSS    // Press
...
#define MP3_BACK_QUES 	"BACQ"    // Returning to the question now.
//#define MP3_BETWEEN BETW    // Please enter a number between:
#define MP3_BETWEEN 	"ERNM"    // Enter the number between:
#define MP3_BETWEEN_S 	"ERNS"    // Enter the numbers between:
#define MP3_EVEN 		"EVEN"    // Enter the even numbers between:
#define MP3_GOOD_NEXT 	"GONX"    // Good. Next,
#define MP3_HUND  		"HUNN"    // How many hundreds are in the number you just entered?
#define MP3_HUNR 		"HUNR"    // Round the following number to the nearest hundred.
...
#define MP3_NO_CORR 	"NOCO"    // No correct answer entered so far.
#define MP3_NEXT 		"NXTN"    // Enter the next number.
#define MP3_ODD  		"ODDN"    // Enter the odd numbers between
#define MP3_SCORE 		"SCOR"    // Your current score is:

#define MP3_TEN  		"TENN"    // How many tens are in the number you just entered?
#define MP3_TENR 		"TENR"    // Round the following number to the nearest ten.
#define MP3_TRY  		"TRY"   // Please try again.
